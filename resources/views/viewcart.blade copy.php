                        ...
                        <tr id="row-{{ $item->id }}">
                            ...
                            <td class="ps-3">
                                ...
                                <div class="d-flex align-items-center mt-2">
                                    <div class="qty-control border px-1 py-0" style="background: #fdfdfd; scale: 0.8; transform-origin: left;">
...
<style> 
    ...
    .table td { border-bottom: 1px solid #f0f0f0; padding: 20px 0; }
    .btn-confirm { background: #1a1a1a; color:white; border-radius: 0; padding: 10px; letter-spacing: 2px; font-size: 0.8rem; transition: all 0.3s; border: 1px solid #1a1a1a; }
    ...
    .card-content i { font-size: 1.2rem; color: #888; }
    .card-content span { font-size: 0.85rem; font-weight: 500; color: #444; }
    
    .payment-card input:checked + .card-content {
        border-color: #b19470;
        background: #fdfaf5;
    }
    .payment-card input:checked + .card-content i { color: #b19470; }
