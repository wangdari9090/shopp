        ...
        <div class="row g-1">
                ...
                <div class="product-detail-img-container shadow-sm bg-white rounded-3 overflow-hidden">
                    <div class="img-wrap p-4">
                        <img id="mainProductImage"
                            ...
                            class="uniform-img-carousel img-fluid" alt="{{ $product->product_title }}"
            ...
            <div class="col-lg-6 col-md-12 d-flex align-items-center">
                <div class="ps-lg-4 w-100">
                    {{-- <span class="text-success fw-bold text-uppercase small tracking-widest">{{ $product->category->name
                        ?? 'Premium Series' }}</span> --}}
                        ...
                        <a href="{{ route('product.details', $item->id) }}" class="text-decoration-none">
                            <div class="img-wrap p-3" style="aspect-ratio: 1/1; background: #fcfcfc;">
                                <img src="{{ asset('storage/products/' . ($item->product_image[0] ?? 'default.jpg')) }}"
                                    class="w-100 h-100 object-fit-contain" alt="{{ $item->product_title }}">
                            </div>
            ...
            if (form) {
                form.onsubmit = function (e) {
                    ...
                    fetch(actionUrl, {
                        ...
                        .then(response => response.status === 401 ? (window.location.href = "{{ route('login') }}") : response.json())
                        .then(data => {
