                        ...
                        @foreach($popularProducts->take(4) as $product)
                            <div class="hero-item-luxury">
                                ...
                                <div class="product-img-box">
                                    ...
                                    <img src="{{ asset('storage/products/' . $firstImage) }}" class="product-img-zoom"
                                ...
                                <div class="product-details-minimal">
                                    <p class="text-muted small mb-1 text-uppercase tracking-wider" style="font-size: 0.65rem;">
                                        Timeless Series</p>
                                    <h6 class="product-title-luxury">{{ $product->product_title }}</h6>
                                    <div class="d-flex justify-content-between align-items-center mt-2">
                                        <span
                                            class="product-price-luxury">${{ number_format($product->product_price, 2) }}</span>
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product-arrival-card-carousel overflow-hidden">
                                                ...
                                                <div class="carousel-item {{ $imgIndex === 0 ? 'active' : '' }}">
                                                    <div class="img-wrap justify-content-center">
                                                        <img src="{{ asset('storage/products/' . $image) }}"
                                                            class="uniform-img-carousel" alt="{{ $product->product_title }}">
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
                                ...
                                <div class="p-3 text-center border-top bg-white">
                                    ...
                                    <div class="mt-2">
                                        <span
                                            class="badge bg-light text-success border border-success-subtle rounded-pill px-3 py-1 fw-bold"
